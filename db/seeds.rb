...
players_on_rosters = [
  ...
  "Darqueze Dennard", "Charles Sims", "Calvin Pryor", "Terrance West", "Jimmie Ward", "Davante Adams",
  "Teddy Bridgewater", "Logan Thomas", "Tom Brady", "Jay Cutler", "Matthew Stafford", "Peyton Manning", "Montee Ball",
  "Alfred Morris", "Jamaal Charles", "LeSean McCoy", "Rashad Jennings", "Frank Gore", "C.J. Spiller", "Le'Veon Bell",
  "Brandon Marshall", "Dez Bryant", "Vincent Jackson", "A.J. Green", "Andre Johnson", "Jordy Nelson", "T.Y. Hilton",
  "Alshon Jeffery", "Antonio Gates", "Kyle Rudolph", "Jared Cook", "Martellus Bennett", "Emmanuel Sanders",
  "Greg Jennings", "Ryan Mathews", "Victor Cruz", "Karlos Dansby", "D'Qwell Jackson", "Stephen Tulloch",
  "Lavonte David", "J.J. Watt", "Rob Ninkovich", "Tracy Porter", "Jurrell Casey", "Morgan Burnett", "Troy Polamalu",
  "Charles Woodson", "DeAngelo Hall", "Laron Landry", "Eric Weddle", "Jay Feely", "Curtis Lofton", "Stephen Gotskowski",
  "Matt Bryant", "Darren McFadden", "Matt Prater", "Trent Richardson", "Drew Brees", "Steve Smith", "Randall Cobb",
  "Stevan Ridley", "BenJarvus Green-Ellis", "Steve Johnson", "DeAngelo Williams", "Jason Witten", "Tyler Eifert",
  "Golden Tate", "Kam Chancellor", "NaVorro Bowman", "Jason Pierre-Paul", "Garrett Graham", "Anthony Spencer",
  "James Jones", "Mike Nugent", "Elvis Dumervil", "Robert Woods", "Aaron Dobson", "Lawrence Timmons", "Sammy Watkins",
  "Maurice Jones-Drew", "EJ Manuel", "Bilal Powell", "Brandin Cooks", "Kenbrell Thompkins", "LeGarrette Blount",
  "Kenny Stills", "Austin Seferian-Jenkins", "Andre Ellington", "HaHa Clinton-Dix", "Jadaveon Clowney", "Isiah Crowell",
  "Nick Foles", "Blake Bortles", "C.J. Mosley", "Eric Ebron", "Tre Mason", "Justin Gilbert", "Aaron Donald",
  "Martavis Bryant", "Kadeem Carey", "Chris Kirksey", "Josh Gordon", "Kiko Alonso", "Sean Lee"
]
